# Failure Diagnostics - phase1_diagnostics_manual

- Predictions file: `C:\Users\Vinay\OneDrive\Desktop\enterprise-knowledge-assistant\artifacts\experiments\phase0\V1_phase0_20260328_135211_baseline\predictions.jsonl`
...
2. **python-general leakage** - count=4, likely_fixability=high, trigger_counts={'ambiguity': 3, 'mismatch_recoverable': 1}
...
- id=man-018 | expected=refuse | predicted=clarify | top=0.392 | second=0.363 | margin=0.029 | mismatch=not_applicable | trigger=ambiguity | bucket=python-general leakage | modules=['sys', 'pathlib', 'statistics']
