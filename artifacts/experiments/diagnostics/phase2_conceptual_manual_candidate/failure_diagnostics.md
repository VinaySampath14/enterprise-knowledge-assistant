# Failure Diagnostics - phase2_conceptual_manual_candidate

- Predictions file: `C:\Users\Vinay\OneDrive\Desktop\enterprise-knowledge-assistant\artifacts\experiments\phase0\V2_phase0_20260328_153424_candidate\predictions.jsonl`
...
2. **conceptual in-domain false refusals** - count=2, likely_fixability=high, trigger_counts={'ambiguity': 2}
3. **python-general leakage** - count=2, likely_fixability=high, trigger_counts={'ambiguity': 2}
4. **other repeated bucket (clarify->answer, ambiguity)** - count=1, likely_fixability=high, trigger_counts={'ambiguity': 1}
