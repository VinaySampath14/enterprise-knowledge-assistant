...
def main() -> None:
    ...
    args = sys.argv[1:]
    if args and args[0] == "--demo-mismatch":
        demo_queries = [
            "In argparse, how do I use glob exactly as documented in argparse?",
            "how to set up squilite connection",
            "How do I open a sqlite3 connection?",
        ]
        ...
        for query in demo_queries:
            ...
            res = gate.decide(hits, query=query)
            print(f"\nQUERY: {query}")
